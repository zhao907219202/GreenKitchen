...
<title>绿色厨房</title>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/issue/issue_step_1.css" />
...
<body>
	...
	<div class="main_body">
		...
		<div class="issue_input">
			<form action="${pageContext.request.contextPath}/issue/stepOne.action" method="post" enctype="multipart/form-data" name="issue_step_1">
			<input type="text" name="title" value="菜谱名称" style="width:595px;height:40px;"/>
			<img id="origin" onclick="imgClick()" src="${pageContext.request.contextPath}/images/issue/cover.jpg" style="width:600px;height:400px;margin-top:15px;"/>
