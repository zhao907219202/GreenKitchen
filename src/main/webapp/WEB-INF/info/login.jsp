...
<body>
	<jsp:include page="/WEB-INF/public/head.jsp" />
	 ...
	 <div class="main_login" style="height:400px;width:1000px;margin:0 auto;background-color: #F8F8F8">
		 <img src="${pageContext.request.contextPath}/images/info/loginPic.jpg" style="height:300px;width:400px;float:left;margin-left:100px;margin-top: 50px;"  />
	 
   	 	 <div style="margin-right:100px;margin-top:70px;float:right;width:300px">
		    <h3>用户登录</h3>
		    <form action="${pageContext.request.contextPath}/info/login.action" method="post" name="login">
		    <table style="line-height:40px;height:230px;">
		    	...
		    	<tr><td style="width:100px;">验证码：</td><td><input type="text" name="checkcode" style="width:140px;"/></td><td><img src='${pageContext.request.contextPath}/CreateCode'></td></tr>
		    	...
		    	<tr><td colspan="3" style="text-align: right"><a href="${pageContext.request.contextPath}/info/goRegisterUi.action">注册新用户</a></td></tr>
	     	 </table>
	   		 </form>
    	 </div>
     </div>
