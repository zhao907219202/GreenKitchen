...
<link rel="stylesheet" type="text/css" href="/GreenKitchen/css/public/index.css" />
				...
				<table>
					<tr>
						<td><div class="element">
								<a href="/GreenKitchen/html/themeIndex_1.html"><img style="width:120px;height:120px"
									src="/GreenKitchen/images/index/theme_1.jpg" />
									<div class="font4" style="margin-top: 10px">生活小窍门</div> </a>
							</div></td>
						<td><div class="element">
								<a href="/GreenKitchen/html/themeIndex_2.html"><img style="width:120px;height:120px"
									src="/GreenKitchen/images/index/theme_2.jpg" />
									<div class="font4" style="margin-top: 10px">走到哪吃到哪</div> </a>
							</div></td>
						<td><div class="element">
								<a href="/GreenKitchen/html/themeIndex_3.html"><img style="width:120px;height:120px"
									src="/GreenKitchen/images/index/theme_3.jpg" />
									<div class="font4" style="margin-top: 10px">食•记</div> </a>
							</div></td>
						<td><div class="element">
								<a href="/GreenKitchen/html/themeIndex_4.html"><img style="width:120px;height:120px"
									src="/GreenKitchen/images/index/theme_4.jpg" />
				...
				<c:forEach items="${users}" var="user">
					<tr>
						<td style="width:120px"><a
							href="/GreenKitchen/info/goUserIndex.action?user_id=${user.id}"><font class="font">${user.username }
							</font></a></td>
					</tr>
				</c:forEach>
			</table>
		...
		<div class="material">
			...
			<table>
				<td><c:forEach items="${materials}" var="material">
						<div class="element">
							<a href="/GreenKitchen/material/goMaterialDetail.action?material_id=${material.id}"><img style="width:70px;height:70px"
